...
class TeacherFeedback(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if (the_class and the_class[0] != member.id): 
        ...
        elif (the_class_vc and the_class_vc[0] != member.id):
            # Checks if user is an active student
    ...
    @utils.is_allowed([mod_role_id, admin_role_id, lesson_management_role_id], throw_exc=True)
