...
4) You can add up to 4 **threads** each for **250 :leaves: **by writing **z!agc text (name of the channel) ** **or** for **500** :leaves:  1 additional voice channel by writing **z!agc voice (name of the channel) ** 
