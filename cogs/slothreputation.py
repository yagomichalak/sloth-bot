...
from mysqldb3 import *
from mysqldb2 import *
from datetime import datetime

commands_channel_id = 699611127901847632
...
class SlothReputation(commands.Cog):
    ...
    async def level(self, ctx):
        ...
        embed = discord.Embed(title="Rank", description=f"Level: {user[0][2]}\nEXP: {user[0][1]}pts.",
    ...
    async def score(self, ctx):
        ...
        leaderboard.set_footer(text=f"Your score: {(await self.get_specific_user(ctx.author.id))[0][4]}")
