...
class Merchant(Player):
    ...
    async def potion(self, ctx, member: discord.Member = None) -> None:
        ...
        if not user_info or not sloth_profile:
            await ctx.send(embed=discord.Embed(description=f"**{buyer.mention}, you don't have an account yet. Click [here](https://discord.languagesloth.com/profile/update) to create one!**"))

        elif sloth_profile[1].lower() == 'default':
            await ctx.send(embed=discord.Embed(description=f"**{buyer.mention}, you don't have a Sloth class yet. Click [here](https://discord.languagesloth.com/profile/slothclass) to choose one!**"))
    ...
    async def ring(self, ctx, member: discord.Member = None) -> None:
        ...
        if not user_info:
            return await ctx.send(embed=discord.Embed(description=f"**{buyer.mention}, you don't have an account yet. Click [here](https://discord.languagesloth.com/profile/update) to create one!**"))

        if slothprofile[1].lower() == 'default':
            return await ctx.send(embed=discord.Embed(description=f"**{buyer.mention}, you don't have a Sloth class yet. Click [here](https://discord.languagesloth.com/profile/slothclass) to choose one!**"))
    ...
    async def get_open_shop_embed(self, channel, perpetrator_id: int, price: int, item_name: str, emoji: str = '') -> discord.Embed:
        ...
        open_shop_embed.set_thumbnail(url="https://discord.languagesloth.com/media/sloth_classes/Merchant.png")
    ...
    async def marry(self, ctx, suitor: discord.Member = None) -> None:
        ...
        * Cost: 1000łł
        ...
        no_pf_view.add_item(discord.ui.Button(style=5, label="Create Account", emoji="🦥", url="https://discord.languagesloth.com/profile/update"))
