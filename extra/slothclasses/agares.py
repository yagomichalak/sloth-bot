...
class Agares(Player):
    ...
    async def get_magic_pull_embed(self, channel, perpetrator_id: int, target_id: int, t_before_vc: discord.VoiceChannel, t_after_vc: discord.VoiceChannel) -> discord.Embed:
        ...
        magic_pull_embed.set_thumbnail(url="https://discord.languagesloth.com/media/sloth_classes/Agares.png")
    ...
    async def get_recharge_embed(self, channel, perpetrator_id: int, target_id: int) -> discord.Embed:
        ...
        recharge_embed.set_thumbnail(url="https://discord.languagesloth.com/media/sloth_classes/Agares.png")
    ...
    async def get_reflect_embed(self, channel, perpetrator_id: int, target_id: int) -> discord.Embed:
        ...
        reflect_embed.set_thumbnail(url="https://discord.languagesloth.com/media/sloth_classes/Agares.png")
    ...
    async def delay(self, ctx, target: discord.Member = None) -> None:
        ...
        if target.id == perpetrator.id:
            return await ctx.send(f"**You cannot use this skill on yourself, {perpetrator.mention}!**")
        ...
        try:
            ...
            if exists:
                ...
                await self.insert_user_skill_cooldown(perpetrator.id, Skill.FOUR, current_ts)
    ...
    async def get_delay_embed(self, channel, perpetrator_id: int, target_id: int) -> discord.Embed:
        ...
        :param channel: The context channel.
        :param perpetrator_id: The ID of the perpetrator of the delay.
        :param target_id: The ID of the target of the delay. """
        ...
        delay_embed.set_thumbnail(url="https://discord.languagesloth.com/media/sloth_classes/Agares.png")
