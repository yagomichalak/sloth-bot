...
class Seraph(Player):
    ...
    async def get_divine_protection_embed(self, channel, perpetrator_id: int, target_id: int) -> discord.Embed:
        ...
        divine_embed.set_thumbnail(url="https://discord.languagesloth.com/media/sloth_classes/Seraph.png")
    ...
    async def get_reinforce_shields_embed(self, channel, perpetrator_id: int, shields_len: int, success_rate: float) -> discord.Embed:
        ...
        reinforce_shields_embed.set_thumbnail(url="https://discord.languagesloth.com/media/sloth_classes/Seraph.png")
    ...
    async def get_self_shield_embed(self, channel, perpetrator_id: int, success_rate: float) -> discord.Embed:
        ...
        self_shield_embed.set_thumbnail(url="https://discord.languagesloth.com/media/sloth_classes/Seraph.png")
    ...
    async def _baby_feed(self, ctx, leaves: str = None) -> None:
        ...
        if confirm_view.value:
            ...
            embed.set_thumbnail(url=f"https://discord.languagesloth.com/static/assets/images/sloth_classes/{user_baby[3]}.png")
