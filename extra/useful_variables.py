...
Rogar repetidamente a los miembros del Staff por cosas puede resultar en advertencias o un baneo.""",
    ...
    "arabic": {
        "ممنوع NSFW": """وهذا ينطبق ،على <المحتوى / المحادثات>: الإباحية ، الدموية ، العنيفة ، الكراهية ، المسيئة.
            لن يتم التسامح معها في أي من القنوات الصوتية أو القنوات النصية.
            تنطبق هذه القاعدة أيضًا على صور الملف الشخصي وأسماء المستخدمين وحالة الديسكورد (Discord Status).
            """,
        "كن محترما": """يحظر التمييز على أساس العرق أو الجنسية أو الدين أو الجنس أو التوجه الجنسي.
            ...
            """,
        "تجنب الجدل": """نظرًا لأن Language Sloth هو سيرفير دولي ذو طبيعة تعليمية ، فلدينا أشخاص من جميع أنحاء العالم هنا. لتجنب النزاعات غير الضرورية ، لا يُسمح بالمواضيع التي تعتبر مثيرة للجدل إلا في نادي المناقشة "Debate club".
            ...
            """,
        "يمنع الاعلان.": """لا يُسمح بالإعلانات أو الترويج الذاتي عبر القنوات النصية / الصوتية أو المحادثات والرسائل الخاصه. 
            إذا كنت ترغب في الحصول على إذن ، فاتصل بفريق العمل الخاص بنا.
            """,
        "لاتقم  بـ  Doxxing": """لا تشارك المعلومات الشخصية للمستخدمين الآخرين  دون موافقتهم  مثل الاسم الحقيقي وعنوان المنزل ومكان العمل والهاتف والمعلومات المالية الخ...""",
        "لا تنتحل شخصية الآخرين": """.لا تنتحل صفة المستخدمين الاخرين أو الموظفين""",
        "لا تترجى ": """لا تطلب ان نمحك رتبة/ ان تصبح من الموظفين. يمكنك التقدم لشغل في هذه الوظائف عن طريق الوصول إلى الرابط في "<#1271659354831192096>" ولكن الطلب  المتكرر قد يؤدي إلى تحذيرات أو حظر..""",
        "دراما": """ابذل قصارى جهدك لإبعاد الدراما عن هذا السيرفر . أي محاولة لبدء الدراما ، أو رفض إنهاء نزاع داخل السيرفر ، قد يؤدي إلى عواقب.ابذل قصارى جهدك لإبعاد الدراما عن هذا السيرفر . أي محاولة لبدء الدراما ، أو رفض إنهاء نزاع داخل السيرفر ، قد يؤدي إلى عواقب.""",
        "قواعد إضافية": """استخدم القنوات النصية والصوتية باستخدام اللغة المقصودة لكل قناة ، فقد يؤدي التحدث بلغات مختلفة إلى إرباك المستخدمين الآخرين وإزعاجهم."""
    }
}
...
different_class_roles = {
    ...
    "english": [
        "english", "inglés", "inglês", "anglais", "ingles",
        "angielski", "englisch", "ingleze", "inglese"
